    ...
    module V4
      module ProtectedAreaParcelSerializer
        ...
        def payload(protected_area_parcel, current_user:, with_geometry:)
          ...
          add_field(payload, "reported_marine_area", current_user.access_to?(ProtectedAreaParcel, :reported_marine_area)) do
          ...
          add_field(payload, "conservation_objectives", current_user.access_to?(ProtectedAreaParcel, :conservation_objectives)) do
