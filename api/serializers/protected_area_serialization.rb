module API
  module Serializers
    module ProtectedAreaSerialization
      module_function
      ...
      def green_list_status_payload(green_list_status, legacy_aliases: false)
        ...
        payload = {
          ...
          "status" => safe_value(green_list_status, :status),
          "expiry_date" => safe_value(green_list_status, :expiry_date),
        ...
        return payload unless legacy_aliases
