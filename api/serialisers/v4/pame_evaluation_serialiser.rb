        ...
        def one(evaluation)
          {
            ...
            'id' => safe_value(evaluation, :asmt_id, lambda {
              evaluation.id
            }), # Alias to asmt_id. It will be removed in next version (v5), use asmt_id.
            ...
            'year' => safe_value(evaluation, :asmt_year, lambda {
              safe_value(evaluation, :year)
            }), # Alias to asmt_year. It will be removed in next version (v5), use asmt_year.
            ...
            'url' => safe_value(evaluation, :asmt_url, lambda {
              safe_value(evaluation, :url)
            }), # Alias to asmt_url. It will be removed in next version (v5), use asmt_url.
