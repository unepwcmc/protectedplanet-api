    ...
    module V3
      module Concerns
        module ProtectedArea
          ...
          def green_list_status_payload(green_list_status)
            return nil unless green_list_status

            {
              'id' => green_list_status.id,
              'status' => safe_value(green_list_status, :gl_status),
              'expiry_date' => safe_value(green_list_status, :gl_expiry),
              'link' => safe_value(green_list_status, :gl_link)
            }
          end
